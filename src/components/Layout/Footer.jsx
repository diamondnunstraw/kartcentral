        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Your premium destination for quality products at competitive prices. Shop with confidence and enjoy our excellent customer service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=electronics" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Electronics
                </Link>
              </li>
              <li>
                <Link to="/products?category=fashion" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Fashion
                </Link>
              </li>
              <li>
                <Link to="/products?category=jewelery" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Jewelry
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/orders" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Track Order
                </Link>
              </li>
              <li>
          ...
          {/* Account Section */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">My Account</h3>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="text-sm text-gray-400">
              <p>&copy; {new Date().getFullYear()} KartCentral. All rights reserved.</p>
              <p className="mt-2">
